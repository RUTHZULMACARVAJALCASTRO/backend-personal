...
export declare class ChargeService {
    ...
    constructor(chargeModel: Model<Charge>);
    create(createChargeDto: CreateChargeDto): Promise<import("mongoose").Document<unknown, {}, Charge> & Charge & {
        _id: import("mongoose").Types.ObjectId;
    }>;
    findAll(): Promise<(import("mongoose").Document<unknown, {}, Charge> & Charge & {
        _id: import("mongoose").Types.ObjectId;
    })[]>;
    filterParams(filterChargeDto: FilterChargeDto): Promise<{
        data: (import("mongoose").Document<unknown, {}, Charge> & Charge & {
            _id: import("mongoose").Types.ObjectId;
        })[];
        total: number;
        totalPages: number;
    }>;
    findOne(id: string): Promise<import("mongoose").Document<unknown, {}, Charge> & Charge & {
        _id: import("mongoose").Types.ObjectId;
    }>;
    update(id: string, updateChargeDto: UpdateChargeDto): Promise<{
        ...
        _id: any;
        __v?: any;
        $assertPopulated: <Paths = {}>(path: string | string[], values?: Partial<Paths>) => Omit<Charge & {
            _id: import("mongoose").Types.ObjectId;
        }, keyof Paths> & Paths;
        $clone: () => Charge & {
            _id: import("mongoose").Types.ObjectId;
        ...
        $inc: (path: string | string[], val?: number) => Charge & {
            _id: import("mongoose").Types.ObjectId;
        };
        ...
        $set: {
            (path: string | Record<string, any>, val: any, type: any, options?: import("mongoose").DocumentSetOptions): Charge & {
                _id: import("mongoose").Types.ObjectId;
            };
            (path: string | Record<string, any>, val: any, options?: import("mongoose").DocumentSetOptions): Charge & {
                _id: import("mongoose").Types.ObjectId;
            };
            (value: string | Record<string, any>): Charge & {
                _id: import("mongoose").Types.ObjectId;
            };
        };
        ...
        deleteOne: (options?: import("mongoose").QueryOptions<unknown>) => Promise<Charge & {
            _id: import("mongoose").Types.ObjectId;
        }>;
        depopulate: (path?: string | string[]) => Charge & {
            _id: import("mongoose").Types.ObjectId;
        };
        ...
        getChanges: () => import("mongoose").UpdateQuery<Charge & {
            _id: import("mongoose").Types.ObjectId;
        }>;
        id?: any;
        increment: () => Charge & {
        ...
        init: (obj: import("mongoose").AnyObject, opts?: import("mongoose").AnyObject) => Charge & {
            _id: import("mongoose").Types.ObjectId;
        };
        invalidate: {
        ...
        overwrite: (obj: import("mongoose").AnyObject) => Charge & {
            _id: import("mongoose").Types.ObjectId;
        };
        $parent: () => import("mongoose").Document<any, any, any>;
        populate: {
            <Paths_1 = {}>(path: string | import("mongoose").PopulateOptions | (string | import("mongoose").PopulateOptions)[]): Promise<import("mongoose").MergeType<Charge & {
                _id: import("mongoose").Types.ObjectId;
            }, Paths_1>>;
            <Paths_2 = {}>(path: string, select?: string | import("mongoose").AnyObject, model?: Model<any, {}, {}, {}, any, any>, match?: import("mongoose").AnyObject, options?: import("mongoose").PopulateOptions): Promise<import("mongoose").MergeType<Charge & {
                _id: import("mongoose").Types.ObjectId;
            }, Paths_2>>;
        };
        populated: (path: string) => any;
        replaceOne: (replacement?: import("mongoose").AnyObject, options?: import("mongoose").QueryOptions<unknown>) => import("mongoose").Query<any, Charge & {
            _id: import("mongoose").Types.ObjectId;
        }, {}, Charge & {
            _id: import("mongoose").Types.ObjectId;
        }, "find">;
        save: (options?: import("mongoose").SaveOptions) => Promise<Charge & {
            _id: import("mongoose").Types.ObjectId;
        }>;
        ...
        set: {
            <T_8 extends string | number | symbol>(path: T_8, val: any, type: any, options?: import("mongoose").DocumentSetOptions): Charge & {
                _id: import("mongoose").Types.ObjectId;
            };
            (path: string | Record<string, any>, val: any, type: any, options?: import("mongoose").DocumentSetOptions): Charge & {
                _id: import("mongoose").Types.ObjectId;
        ...
        updateOne: (update?: import("mongoose").UpdateWithAggregationPipeline | import("mongoose").UpdateQuery<Charge & {
            _id: import("mongoose").Types.ObjectId;
        }>, options?: import("mongoose").QueryOptions<unknown>) => import("mongoose").Query<any, Charge & {
            _id: import("mongoose").Types.ObjectId;
        }, {}, Charge & {
            _id: import("mongoose").Types.ObjectId;
        }, "find">;
